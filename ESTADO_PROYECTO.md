...
6. **Fase 15 — Layout "libro" (en curso).** El dueño pidió replicar la sección "The Story" de
   ...
   **15c** ✅ *(2026-09-07 — §27)* la sección se queda **fija** (`sticky`, solo escritorio + sin
   ...
   teclado, el rendimiento). **15d** pulido (portada desde el `theme`, páginas de video, CTA). No
   depende de Stripe ni del despliegue.
