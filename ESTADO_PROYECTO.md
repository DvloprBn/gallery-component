...
**Todas las fases + pulido + endurecimiento + reencuadre + protección + Fase 12a/12b/12c completos (2026-09-04).**
...
4. **Fase 10b, 11, 12a, 12b y 12c hechas** — con ellas, el flujo completo de venta (solicitud →
   cotización → licencia → entrega de un solo uso) ya funciona de punta a punta. Sigue **12d**
   (registro de licencias emitidas + botón "Solicitar licencia" en la foto/lightbox + bandeja
   unificada — la última sub-tarea, mayormente ensamblaje de lo ya construido). La Fase 13 (pago
   Stripe) espera a ≈2026‑09‑17. `CLAUDE.md` "Qué es este proyecto" actualizado al marco nuevo.
