...
**Todas las fases + pulido + endurecimiento + reencuadre + protección + Fase 12a completos (2026-09-04).**
...
4. **Fase 10b, 11 y 12a hechas.** Sigue **12b** (cotizar) → **12c** (emitir licencia + entrega
   firmada de un solo uso) → **12d** (frontend público + pulido). La Fase 13 (pago Stripe) espera a
   ≈2026‑09‑17. `CLAUDE.md` "Qué es este proyecto" actualizado al marco nuevo.
