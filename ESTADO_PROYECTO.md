...
6. **Fase 15 — Layout "libro" (en curso).** El dueño pidió replicar la sección "The Story" de
   ...
   **15c** scroll fijo (`sticky`) que pasa las páginas + teclado + pasada de rendimiento. **15d**
   pulido (portada desde el `theme`, páginas de video, CTA). No depende de Stripe ni del despliegue.
